...
<?php include('../session.php'); ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
            <?php include('sidebar_uploaded_files.php'); ?>
                            ...
                            <div class="block-content collapse in">
								...
								<form action="" method="post">
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
										<!-- where region ='$staff_region' -->
													<?php

													
													$user = mysqli_query($conn,"select * from file where sender='$user_name'")or die(mysqli_error());
                                                ...
                                                <!-- <td><a href="<?php echo $file_path; ?>" class="btn btn-primary" download>Access</a></td> -->
